...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_ModelIndexer'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_ModelIndexer.kb_ModelIndexerImpl import kb_ModelIndexer  # noqa @IgnorePep8
impl_kb_ModelIndexer = kb_ModelIndexer(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_ModelIndexer'
        ...
        self.rpc_service.add(impl_kb_ModelIndexer.fbamodel_index,
